 ...
 * Site controller
 */
class Product2Controller extends BackController
{

    public $modelClass = 'common\models\FinanceProduct';
    public $modelSearchClass = 'common\models\search\FinanceProductSearch';

    public $model2Class = 'common\models\CreditorProduct';
    public $modelSearch2Class = 'common\models\search\CreditorProductSearch';
    ...
    public function actionFinance()
    {
        ...
        return $this->renderIsAjax('finance', compact('dataProvider', 'searchModel'));
    ...
    public function actionIndex(){
        ...
        $modelClass = $this->model2Class;
        $searchModel = $this->modelSearch2Class ? new $this->modelSearch2Class : null;
