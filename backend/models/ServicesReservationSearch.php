...
/**
 * ServicesReservationSearch represents the model behind the search form about `app\models\ServicesReservation`.
 */
class ServicesReservationSearch extends ServicesReservation
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [[ 'province_id', 'city_id', 'district_id', 'create_user', 'contacts', 'tel', 'desc', 'status'], 'safe'],
        ];
    }
    ...
    {
        $query = ServicesReservation::find();
