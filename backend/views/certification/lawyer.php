...
<div class="gren">
    <div class="gren_xi">
        <div class="personal_xi clearfix">
            <h4>律所基本信息</h4>
            <span></span>
            <p>(律所可发布融资、清收、诉讼，可代理诉讼、清收)</p>
            <?php if(isset($certi->email)&&$certi->email == ''|| isset($certi->casedesc)&&$certi->casedesc == ''){?>
            <a href="<?php echo \yii\helpers\Url::toRoute(['/certification/modify','type'=>2])?>">
        ...
        <div class="yi3">
            <a href="<?php echo \yii\helpers\Url::toRoute(['/certification/add','type'=>2])?>">
