...
/* @var $model app\models\ServicesReservation */
$status = ServicesReservation::$status;

$this->title = "详情#".$model->id;
$this->params['breadcrumbs'][] = ['label' => '法律服务-合同起草', 'url' => ['reservation-index']];
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="services-reservation-view">
	<p>
        <?php 
		$html = '';
		if($model->status == 10){
...
$(document).ready(function(){ 
	...
	$(document).on("click",'.btnAudit',function(){
			...
			$.ajax({
				...
				data: {id:curid, curstatus:curstatus, tostatus:tostatus, memo:memo,type:1},
				dataType: "json",
