    ...
    <header>
        <div class="cm-header">
			...
			<?php if($certification['state']==2){ ?>
              <a href="<?php echo yii\helpers\Url::to(['/certification/add','status'=>2])?>"><span class="">编辑</span></a>
            <?php }else{ echo '';}?>
        </div>
        ...
        <div class="rz_name">
            <ul>
                ...
                <li>
                    ...
                    <span class="y_name"><a href="tel:4008557022"><?php echo isset($certification['mobile'])?$certification['mobile']:'暂无';?></a></span>
                </li>
                <li>
...
<div class="hint">
	<div class="hint-in1">
      <?php $cardimg = explode(',',$certification['cardimg']);?>
		<div class="hint2"><img src="<?php echo isset($cardimg)?Yii::$app->params['wx'].substr(array_pop($cardimg),1,-1):''?>" style="height:230px;width:300px; display:inline-block;"/></div>
		<div class="hint3"></div>
	</div>
</div>
