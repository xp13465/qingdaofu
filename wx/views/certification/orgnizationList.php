        ...
        <div class="cm-header">
			...
			<?php if($certification['state']==2){?>
                <div class="write">
                    ...
                    <a href="<?php echo yii\helpers\Url::to(['/certification/add','status'=>3])?>"><span class="">编辑</span></a>
                </div>
            <?php }else{ echo '';}?>
        </div>
    </header>
    ...
    <div class="person_xi">
        ...
        <div class="rz_name">
            <ul>
                ...
                <li>
                    <span class="x_name">联系人:</span>
                    <span class="y_name"><?php echo isset($certification['contact'])?$certification['contact']:'暂无';?></span>
                </li>
                <li>
                    <span class="x_name">联系方式:</span>
                    <span class="y_name"><?php echo isset($certification['mobile'])?$certification['mobile']:'暂无';?></span>
                </li>
                <li>
                    <span class="x_name">公司经营地址:</span>
                    <span class="y_name"><?php echo isset($certification['address'])?$certification['address']:'暂无';?></span>
                </li>
                <li>
                    <span class="x_name">公司网站:</span>
                    <span class="y_name"><?php echo isset($certification['enterprisewebsite'])?$certification['enterprisewebsite']:'暂无';?></span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <textarea name="" id="" class="y_name"><?php echo isset($certification['casedesc'])?$certification['casedesc']:'暂无';?></textarea>
                </li>
            </ul>
        </div>
    </div>
