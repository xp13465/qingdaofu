...
<div class="wt_xieyi">
	...
	<p style="text-indent:20px;">
		鉴于甲方作为合法债权人或合法债权人的受托人欲寻找提供法律服务的律师事务所。乙方作为居间方接受甲方委托为其提供律师事务所供选择。根据《中华人民共和国合同法》的有关规定，本着自愿、平等、互利、诚实信用的原则，现双方经过友好协商，达成一致协议如下：</p></br>

	<p><h4>一、居间服务内容：</h4></p></br>
	<p style="text-indent:20px;">1.乙方通过自身及其所有的服务平台为甲方提供适合的律师事务所，促成甲方与有律师事务所形成委托关系。当甲方与律师事务所签署相关委托代理合同时即表示乙方完成本协议约定的居间服务，甲方按照本协议约定向乙方支付居间服务费。</p>
	<p style="text-indent:20px;">2. 乙方仅按照本协议约定提供居间服务，公示服务平台用户注册信息，不对甲方和律师事务所之间的委托代理提供针对任何一方的保证、担保以及任何承诺。甲方和律师事务所之间关于委托代理合同的任何纠纷均由其双方自行解决，与乙方无关。</p></br>
	<p><h4>二、居间服务方式：</h4></p></br>
	<p style="text-indent:20px;">1. 甲方作为合法债权的债权人或合法债权人指定的受托人通过乙方所有的清道夫债管家网络服务平台（网络域名www.zcb2016.com)或APP应用软件上按要求注册成为用户，并提供真实身份信息（姓名、身份证号码、住所等）或法人信息（包括名称、法定代表人、住所等）、联系人、联系地址、联系电话等。乙方通过清道夫债管家网络服务平台为甲方推送在服务平台上已注册的提供法律服务的律师事务所。</p>
	<p style="text-indent:20px;">2. 甲方根据自身需要从乙方推送的用户中选择律师事务所并与其签订委托代理合同。</p>
	<p style="text-indent:20px;">3. 乙方仅对服务平台上提供给甲方的律师事务所做形式审查，乙方对提供给甲方律师事务所的真实性不承担任何责任。</p></br>
	<p> <h4>三、委托期限</h4></p></br>
	...
	<p style="text-indent:20px;">乙方通过网络服务平台为甲方提供居间服务，甲方应向乙方支付居间服务费。居间服务费的收取方式如下：</p>
	<p style="text-indent:20px;">1. 甲方通过乙方网络服务平台提供的居间服务与律师事务所达成初步法律服务委托代理意向，双方初步确定委托代理合同的标的金额为人民币¥<b class="b1 fw"><?php echo isset($data['money'])?$data['money']:''?></b>。</p>
	<p style="text-indent:20px;">2.甲方通过乙方网络服务平台与律师事务所达成初步法律服务委托意向后的十个工作日内双方应协商签订委托代理合同并确定最终委托代理合同的标的金额。甲方应在与律师事务所签署委托代理合同之日将居间服务费¥<b class="b1 fw">0</b>元支付给乙方。</p>
	...
	<p style="text-indent:20px;">2.甲方对乙方及其服务平台推荐的律师事务所及其律师的相关信息资料进行核实，乙方应配合甲方开展相应业务。</p>
	<p style="text-indent:20px;" >3.甲方通过乙方及其服务平台选定律师事务所后，应及时与律师事务所以及相关律师签订委托代理合同并通过完善服务平台网站资料的方式告知乙方。</p>
	<p style="text-indent:20px;">4.甲方对乙方推荐律师事务所具有完全的选择权，乙方不得干预甲方意愿。</p>
	<p style="text-indent:20px;">5.甲方与乙方推荐的律师事务所不得以任何理由或形式在居间活动中私下签署委托代理合同形成委托关系。如若出现上述行为，仍视为乙方已完成本协议约定居间服务，乙方有权取得约定的全部的居间服务费。同时，甲方应按其与律师事务所签署委托代理合同中约定的律师费金额为标准支付乙方违约金。</p>
	<p style="text-indent:20px;">6.凡经乙方推荐的律师事务所同时甲方也通过其他渠道取得该同一律师事务所的，此时为了秉持客观公证原则，甲方须以包括乙方在内的各渠道方向甲方推荐律师事务所信息的时间先后为依据来对律师事务所的推荐方进行确认，以时间前者为准。</p>
	<p style="text-indent:20px;">7.甲方通过乙方及其服务平台获得律师事务所信息后，不得以任何理由或形式将律师事务所的信息资料披露给予第三方机构或个人。否则，甲方应按其与律师事务所签署委托代理合同中约定的律师费金额为标准支付乙方违约金。</p>
	<p style="text-indent:20px;">8.甲方通过乙方及其服务平台的居间服务一旦选择律师事务所，甲方应及时根据乙方平台的规则完善居间服务平台网站上的相关信息资料，保证居间服务资料的完整性。甲方应在与律师事务所签订律师委托代理合同后的七个工作日内完善相关居间服务平台网站上的信息资料，否则视为甲方违约，甲方由此承担可能给乙方造成的居间服务费损失。</p>
	<p style="text-indent:20px;">9.甲方应遵守乙方平台系统中的各项规则，包括本协议签署时已经存在的或日后修订的或日后新增的规则，并同意按照平台系统的规则接受给予的处罚。</p>
	<p style="text-indent:20px;">10.乙方向甲方提供的律师事务所的资料完全基于律师事务所代理人自行填写，乙方不对律师事务以及律师资料的真实性负最终责任。</p>
	<p style="text-indent:20px;">11．乙方应认真完成甲方的委托事项，并为甲方和律师事务所签署合同提供联络、协助、撮合等服务。</p></br>
	<p><h4>六、违约条款</h4></p></br>
	<p style="text-indent:20px;">
