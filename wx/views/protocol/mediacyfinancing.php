...
<div class="wt_xieyi">
    ...
    <p style="text-indent:20px;">
       鉴于甲方作为借款人或借款人的指定受托人有资金需求欲寻找有意向的出借人，委托乙方寻找出借人。乙方作为居间方接受甲方委托为其提供出借人供选择。根据《中华人民共和国合同法》的有关规定，本着自愿、平等、互利、诚实信用的原则，现双方经过友好协商，达成一致协议如下：</p></br>

    <p><h4>一、居间服务内容：</h4></p></br>
    <p style="text-indent:20px;">1.乙方通过自身及其所有的服务平台为甲方提供有投资意向的出借人,促成甲方与出借人签订借款合同。当甲方与出借人签订借款合同时即表示乙方完成本协议约定的居间服务，甲方按照本协议约定向乙方支付居间服务费。</p>
    <p style="text-indent:20px;">2.乙方仅按照本协议约定提供居间服务，公示服务平台用户注册信息，不对甲方和出借人之间的借款活动提供任何借款和还款的保证、担保以及任何承诺。甲方和出借人之间关于借款合同的任何纠纷均由其双方自行解决，与乙方无关。</p></br>
    <p><h4>二、居间服务方式：</h4></p></br>
    <p style="text-indent:20px;">1. 甲方作为借款人或借款人指定受托人通过乙方所有的清道夫债管家网络服务平台（网络域名www.zcb2016.com)或APP应用软件上按要求注册成为用户，并提供真实身份信息（姓名、身份证号码、住所等）或法人信息（包括名称、法定代表人、住所等）、联系人、联系地址、联系电话等。乙方通过清道夫债管家网络服务平台为甲方推送在服务平台上已注册的有资金出借意向的出借人。</p>
    <p style="text-indent:20px;">2. 甲方根据自身需要从乙方推送的用户中选择出借人并与其签订借款协议。</p>
    <p style="text-indent:20px;">3. 乙方仅对服务平台上提供给甲方的用户做形式审查，乙方对提供给甲方的出借人信息的真实性不承担任何责任。</p></br>
    <p> <h4>三、委托期限</h4></p></br>
    ...
    <p style="text-indent:20px;">1.甲方通过乙方网络服务平台的居间服务与出借人用户达成借款的初步意向并相互取得联系方式。双方初步确定借款合同的标的金额为人民币<b class="b1 fw"><?php echo isset($data['money'])?$data['money']:''?>万元</b>，借款期限为<b class="b1 fw"><?php if(isset($data['rate_cat'])){if($data['rate_cat'] == 1)echo $data['term'];elseif($data['rate_cat'] == 2)echo 30*$data['term'];}?></b>天，借款月利率为<b class="b1 fw"><?php if(isset($data['rate_cat'])){if($data['rate_cat'] == 1)echo 30*$data['rate'];elseif($data['rate_cat'] == 2)echo $data['rate'];}?></b>%。</p>
    <p style="text-indent:20px;">2．甲方通过乙方网络服务平台的居间服务与出借人用户达成初步意向后的十个工作日内双方应协商签订借款合同并确定最终借款合同的标的金额。甲方与出借人签订借款合同之日应向乙方一次性支付居间服务费。居间服务费收取以甲方与出借人最终签订的借款合同约定的借款标的金额的 <b class="b1 fw">0</b>％收取.</p>
    ...
    <p><b class="b1">开户行：中信银行 上海浦东分行</b></p></br>

    <p><h4>五、甲乙双方权利义务</h4></p></br>
    <p style="text-indent:20px;">1.甲方保证是中华人民共和国境内具有签订履行本协议所必须的民事权利和行为能力的法人或自然人，可独立承担民事责任。</p>
    <p style="text-indent:20px;">2.甲方对乙方及其服务平台推荐的出借人进行选择，乙方配合甲方开展相应业务。</p>
    <p style="text-indent:20px;">3.甲方通过乙方及其服务平台选定出借人后，应及时与出借人签订借款合同等相关协议并通过完善服务平台网站资料的方式告知乙方。</p>
    <p style="text-indent:20px;">4.甲方对出借人有完全的选择权，乙方不得干预甲方意愿。</p>
    <p style="text-indent:20px;">5.甲方接受乙方居间服务提供的出借人后，甲方应及时向乙方反馈甲乙双方达成协议，签署合同以及借款发放的相关情况。甲方应通过完善服务平台网站资料的方式告知乙方。</p>
    <p style="text-indent:20px;">6.甲方与乙方推荐的出借人不得以任何理由或形式在居间活动中私下签署委托借款合同。如若出现上述行为，仍视为乙方已完成本协议约定居间服务，乙方有权取得全部的居间服务费。同时，甲方应按其与出借人签署的借款合同金额的10%的标准支付乙方违约金。</p>
    <p style="text-indent:20px;">7.甲方通过乙方及其服务平台获得出借人信息后，不得以任何理由或形式将出借人的信息资料披露给予第三方机构或个人。一经发现，甲方按该笔借款的标的金额向乙方赔偿，并在三个自然日内完成赔偿款项的支付。</p>
    <p style="text-indent:20px;">8.凡经乙方推荐的出借人同时甲方也通过其他渠道取得该同一出借人的，此时为了秉持客观公证原则，甲方须以包括乙方在内的各渠道方向甲方推荐出借人信息的时间先后为依据来对该笔借款申请的推荐方进行确认，以时间前者为准。</p>
    <p style="text-indent:20px;">9.甲方通过乙方及其服务平台的居间服务一旦选择合适的出借人，甲方应及时根据乙方平台的规则完善居间服务平台网站上的相关信息资料，保证居间服务资料的完整性。甲方应在与出借人签订借款合同后的七个工作日内完善相关居间服务平台网站上的信息资料（包括不限于实际借款合同的金额，利率，借款期限等信息），否则视为甲方违约，甲方由此承担可能给乙方造成的居间服务费损失。</p>
    <p style="text-indent:20px;">10.甲方应遵守乙方平台系统中的各项规则，包括本协议签署时已经存在的或日后修订的或日后新增的规则，并同意按照平台系统的规则接受给予的处罚。</p>
    <p style="text-indent:20px;">11.乙方向甲方提供的出借人资料完全基于出借人或其代理人自行填写，乙方不对出借人的资料的真实性负最终责任。</p></br>
    <p><h4>六、违约条款</h4></p></br>
    <p style="text-indent:20px;">
    ...
    <p style="text-indent:20px;"><h4>七、不可抗力</h4></p>
    <p style="text-indent:20px;">1、“不可抗力”是指甲乙双方不能合理控制、不可预见或即使预见亦无法避免的事件，该事件妨碍、影响或延误任何一方根据协议履行其全部或部分义务。该事件包括但不限于政府行为与个人自然灾害、战争、电信部门技术性调整、黑客攻击、软件中毒或任何其它类似事件。</p>
