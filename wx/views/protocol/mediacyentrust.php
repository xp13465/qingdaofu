...
?>
<div class="wt_xieyi">
    <p style="font-size:16px;font-weight:bold;"><b>协议编号：<b class="b1"><?= $data['number']?></b></b></p>
    <div class="wtr jujian">
        <p>甲方： <b class="b1"><?= isset($data['releaseUser'])?$data['releaseUser']['name']:($data['fabuuser']['realname']?$data['fabuuser']['realname']:$data['fabuuser']['username'])?></b></p>
        <p>证件号码（身份证号/营业执照号）： <b class="b1"><?= $data['releaseUser']['cardno']?></b></p>
        <p>联系邮箱： <b class="b1"><?= $data['releaseUser']['email']?></b></p>
    </div>
    ...
    <p style="text-indent:20px;">1.乙方通过自身及其所有的服务平台为甲方提供适合的清收公司，促成甲方与有清收公司形成委托关系。当甲方与清收公司签署委托代理合同时即表示乙方完成本协议约定的居间服务，甲方按照本协议约定向乙方支付居间服务费。</p>
    <p style="text-indent:20px;">2.乙方仅按照本协议约定提供居间服务，公示服务平台用户注册信息，不对甲方和清收公司之间的委托代理提供针对任何一方的保证、担保以及任何承诺。甲方和清收公司之间关于委托代理合同的任何纠纷均由其双方自行解决，与乙方无关。</p></br>
    <p><h4>二、居间服务方式：</h4></p></br>
    <p style="text-indent:20px;">1. 甲方作为合法债权的债权人或合法债权人指定的受托人通过乙方所有的清道夫债管家网络服务平台（网络域名www.zcb2016.com)或APP应用软件上按要求注册成为用户，并提供真实身份信息（姓名、身份证号码、住所等）或法人信息（包括名称、法定代表人、住所等）、联系人、联系地址、联系电话等。乙方通过清道夫债管家网络服务平台为甲方推送在服务平台上已注册的清收公司。</p>
    <p style="text-indent:20px;">2. 甲方根据自身需要从乙方推送的用户中选择清收公司并与其签订相关委托代理合同。</p>
    <p style="text-indent:20px;">3. 乙方仅对服务平台上提供给甲方的清收公司做形式审查，乙方对提供给甲方用户的真实性不承担任何责任。</p></br>
    <p> <h4>三、委托期限</h4></p></br>
    ...
    <p>乙方通过网络服务平台为甲方提供居间服务，甲方应向乙方支付居间服务费。
        居间服务费的收取方式如下：</p>
    <p style="text-indent:20px;">1.甲方通过乙方网络服务平台的居间服务与清收公司达成委托代理的初步意向并相互取得联系方式。双方初步确定委托代理合同的标的金额为人民币<b class="b1 fw"><?= $data['account']?round($data['account']/10000):''?>万元</b>。</p>
    <p style="text-indent:20px;">2. 甲方通过乙方网络服务平台的居间服务与清收公司达成初步意向后的十个工作日内双方应协商签订委托代理合同并确定最终委托代理合同的标的金额。甲方应在甲方与清收公司签署委托代理合同之日将居间报酬¥<b class="b1 fw">0</b>支付给乙方。</p>
    ...
    <p style="text-indent:20px;">1.甲方保证是中华人民共和国境内具有签订履行本合同所必须的民事权利和行为能力的自然人或法人并拥有合法债权，可独立承担民事责任。</p>
    <p style="text-indent:20px;">2.甲方对乙方及其服务平台推荐的清收公司的相关信息资料进行核实，乙方应配合甲方开展相应业务。</p>
    <p style="text-indent:20px;">3.甲方通过乙方及其资产服务平台选定清收公司，应及时与清收公司签订相关清收合同并通过完善服务平台网站资料的方式告知乙方。</p>
    <p style="text-indent:20px;">4.甲方对乙方推荐的清收公司具有完全的选择权，乙方不得干预甲方意愿。</p>
    <p style="text-indent:20px;">5.甲方与乙方推荐的清收公司不得以任何理由或形式在居间活动中私下签署委托代理合同形成委托关系。如若出现上述行为，仍视为乙方已完成本协议约定居间服务，乙方有权取得全部的居间服务费。同时，甲方应按其与清收公司签署合同中确定的收费方式为标准支付乙方违约金。</p>
    <p style="text-indent:20px;">6.甲方通过乙方及其服务平台的居间服务一旦选择合适的清收公司，甲方应及时根据乙方平台的规则完善居间服务平台网站上的相关信息资料，保证居间服务资料的完整性。甲方应在与清收公司签订清收协议后的七个工作日内完善相关居间服务平台网站上的信息资料，否则视为甲方违约，甲方由此承担可能给乙方造成的居间服务费损失。</p>
    <p style="text-indent:20px;">7.甲方通过乙方及其服务平台获得信息后，不得以任何理由或形式将清收公司的信息资料披露给予第三方机构或个人。否则，甲方应按其与清收公司签署的委托代理合同收费金额支付乙方违约金。</p>
    <p style="text-indent:20px;">8. 凡经乙方推荐的清收公司同时甲方也通过其他渠道取得该清收公司信息的，此时为了秉持客观公证原则，甲方须以包括乙方在内的各渠道方向甲方推荐清收公司信息的时间先后为依据来对该清收公司的推荐方进行确认，以时间前者为准。</p>
    <p style="text-indent:20px;">9.甲方应遵守乙方平台系统中的各项规则，包括本协议签署时已经存在的或日后修订的或日后新增的规则，并同意按照平台系统的规则接受给予的处罚。</p>
    <p style="text-indent:20px;">10.乙方向甲方提供的清收公司的资料完全基于清收公司相关人员自行填写，乙方不对清收公司资料的真实性负最终责任。清收公司及其受托人若采取非法方式清收的，乙方不承担任何责任。</p>
    <p style="text-indent:20px;">11.乙方应认真完成甲方的委托事项，并为甲方和清收公司或其代理人签署合同提供联络、协助、撮合等服务。</p></br>
    <p><h4>六、违约条款</h4></p></br>
    ...
    <p style="text-indent:20px;"><h4>八、协议变更和解除</h4></p></br>
    ...
    <p class="clearfix"><span class="fl">甲方 : <b class="b1"><?= isset($data['releaseUser'])?$data['releaseUser']['name']:($data['fabuuser']['realname']?$data['fabuuser']['realname']:$data['fabuuser']['username'])?></b></span>　　<span class="fr">乙方：直向资产管理有限公司</span></p>
    <p>  甲方代理人 : <b class="b1"><?= isset($data['releaseUser'])?$data['releaseUser']['name']:($data['fabuuser']['realname']?$data['fabuuser']['realname']:$data['fabuuser']['username'])?></b></p>
    <p class="jia">本合同签订日期: <b class="b1"><?= date('Y',$data['agreementApply']['modify_at']) ?></b>年<b class="b1"><?= date('m',$data['agreementApply']['modify_at']) ?></b>月<b class="b1"><?= date('d',$data['agreementApply']['modify_at']) ?></b>日</p>
</div>
