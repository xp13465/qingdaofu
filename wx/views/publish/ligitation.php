...
?>
<?=wxHeaderWidget::widget(['title'=>'发布诉讼','gohtml'=>''])?>
    ...
    <ul class="infor">
        ...
        <div class="infor_l">
         <span>费用类型</span>
		  ...
		  <?php echo Html::dropDownList('agencycommissiontype','',[''=>'请选择','1'=>'固定费用','2'=>'风险费率'],['style'=>"width:65%;left:35%;height:50px;"])?>
          </div>
          </span> 
        </div>
      </li>
       <li class="selected03" style="display:none;">
        ...
        <li class="infor_li infor_li01 guaran" style="border-bottom:1px solid #ddd" >
            <div class="infor_l">
                <span>抵押物地址</span>
                    <?php echo  html::dropDownList('province_id','310000',\wx\services\Func::getProvince(),["class"=>"selects selects_three"]);?> <i></i>
        ...
        <li class="car infor_l" style="display: none;font-size: 12px;">
            <span>车牌类型</span>
            <input type="radio" name="licenseplate" value="1" style="width: 6% !important;">沪牌
            <input type="radio" name="licenseplate" value="2" style="width: 6% !important;">非沪牌
        </li>
...
<section class="sup"  style="display:none;">
    ...
    <ul class="supplement infor">
        ...
        <li class="bot_line">
            <div class="infor_l">
            <span>合同履行地</span>
			    <?php echo  html::dropDownList('place_province_id','310000',\wx\services\Func::getProvince(),["class"=>"selects selects_three"]);?> <i></i>
...
<script>
    $(function(){
       ...
       if($("input[name='money']").val() != ''){$("input").attr('style',"font-size:18px;");$('input[type=radio]').attr('style','width:6%')}
        ...
        function save(type){
            $.ajax({
                url:"<?php echo \yii\helpers\Url::toRoute('/publish/ligitation')?>",
                type:'post',
