    ...
    <div class="add_tu" style="margin-top:12px;">				
        <div class="img-box">
        	...
        	<div class="photo_11" name="0">
                ...
                <?php } ?>
                <span class="pic">
                    <?php echo \yii\helpers\Html::hiddenInput($val,$model[$val],['data_url'=>'']);?>
...
$(document).ready(function(){
   ...
   */
   $('.zhen').click(function(){
       ...
       $.ajax({
        url:"<?php echo yii\helpers\Url::toRoute('/preservation/picturedata')?>",
        type:'post',
        data:$('#Picture').serialize(),
        dataType:'json',
        success:function(json){
            if(json.code == '0000'){
                    location.href="<?php echo yii\helpers\Url::toRoute('/preservation/audit')?>"+"?id="+id;
            }
        }
       })
   });
