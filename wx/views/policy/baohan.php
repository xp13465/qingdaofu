...
?>
<?=wxHeaderWidget::widget(['title'=>'我的保函','gohtml'=>'<a href="javascript:void(0);" class="reload"><img src="/images/refresh.png"  width="25" height="25"></a>'])?>
     <section>     
     	<div class="progress">
     		<div class="jin">
     			<div class="jint">
        ...
        <ul style="margin-top:12px;">        	 
            <li>
                <div class="lianxi">
                    <div class="kefu">                    
                        <span class="shuzi" style="font-size:18px;">保函详情</span>
                    </div>                 
                </div>
            </li>        
            <li>
                <div class="lianxi">
                    <div class="kefu">                    
                        <span class="shuzi">保函金融</span>
                        <span class="shuzi" style="float:right;padding-right:20px"><?= isset($model['money'])?round($model['money']/10000):''?>万</span>
                    </div>                 
                </div>
            </li>
            <li>
            ...
            <li>
                <div class="lianxi">
                    <div class="kefu">                    
                        ...
                        <span class="shuzi"><a href="<?= yii\helpers\Url::toRoute(['/policy/picture','id'=>$model['id']])?>"  style="float:right;color:#0079FF;padding-right:20px">编辑</a></span>
						<?php } ?>
                    </div>                 
                </div>
            </li>
