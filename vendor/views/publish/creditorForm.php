...
<?php \yii\widgets\ActiveForm::begin(['id'=>'financing','method'=>'post','options'=>['enctype'=>"multipart/form-data"],])?>
    ...
    <div class="detail pl">
        <ul>
            ...
            <li class="clearfix">
                借款利率 : <?php echo html::input('text','rate',$model->rate,['class'=>"tian"])?> % <i></i> 
                月<?php echo Html::hiddenInput('rate_cat','2')?><i></i></li>
            <li>
            ...
            <li class="mr">担保物 (抵押物) 所在地 <?php echo  html::dropDownList('city_id','310100',['310100'=>'上海市']);?> 
                <?php echo  html::dropDownList('district_id',$model->district_id,\frontend\services\Func::getDistrictByCity('310100'));?><i></i><?php echo html::input('text','seatmortgage',$model->seatmortgage)?><i></i>
            </li>
