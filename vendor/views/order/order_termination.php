    ...
    <table cellspacing="1" cellpadding="0">
        ...
        <?php foreach($creditor as $v):?>
            <tr>
                ...
                <td><?php echo  '处理中'; ?></td>
                <td><a href="#" onclick="inquire('<?php echo $v['id']?>','<?php echo $v['category']?>');">查看</a> <a href="#" onclick="closeProduct('<?php echo \yii\helpers\Url::to('/apply/closeproduct')?>',<?php echo $v['category'];?>,<?php echo $v['id']?>,'3');">终止</a>  <a href="#" onclick="closeProduct('<?php echo \yii\helpers\Url::to('/apply/closeproduct')?>',<?php echo $v['category'];?>,<?php echo $v['id']?>,'4');">结案</a>  </td>
            </tr>
        <?php endforeach;?>
        </tbody>
    </table>
