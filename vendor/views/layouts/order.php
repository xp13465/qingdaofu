...
<div class="cont">
    <div class="content clearfix">
        ...
        <div class="message">
            <ul class="publish">
                <li><a href="<?php echo \yii\helpers\Url::to('/order/ordersave')?>">收藏列表</a></li>
                <li><a href="<?php echo \yii\helpers\Url::to('/order/orderapply')?>">申请中</a></li>
                <li><a href="<?php echo \yii\helpers\Url::to('/order/ordertermination')?>">处理中</a></li>
                <li><a href="<?php echo \yii\helpers\Url::to('/order/orderclosure')?>">已结案</a></li>
            </ul>
            <div class="mytable">
                <?php echo $content;?>
            </div>
