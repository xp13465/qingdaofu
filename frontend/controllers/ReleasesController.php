...
class ReleasesController extends \wx\components\FrontController{
    ...
    public function actionCoufirm(){
        ...
        if(Yii::$app->request->isAjax){
            $id = Yii::$app->request->post('id');
            $category = Yii::$app->request->post('category');
            echo Func::CurlPost(yii\helpers\Url::toRoute('/wap/public/coufirm'),['token'=>$token,'id'=>$id,'category'=>$category]);die;
        }
    }
    ...
    public function actionCancel(){
        ...
        if(Yii::$app->request->isAjax){
            $id = Yii::$app->request->post('id');
            $category = Yii::$app->request->post('category');
            echo Func::CurlPost(yii\helpers\Url::toRoute('/wap/public/cancel'),['token'=>$token,'id'=>$id,'category'=>$category]);die;
        }
    }
    ...
    public function actionDeleteproduct(){
        ...
        if(Yii::$app->request->isAjax){
            $id = Yii::$app->request->post('id');
            $category = Yii::$app->request->post('category');
            echo Func::CurlPost(yii\helpers\Url::toRoute('/wap/public/deleteproduct'),['token'=>$token,'id'=>$id,'category'=>$category]);die;
        }
    }
