...
<div class="firm">
    <div class="firm_1">
        <div class="f_top">
            <p class="case"><a href="<?php echo yii\helpers\Url::toRoute('/homepage/personal')?>">经典案例</a> > <span class="color"><?php echo isset($intr['name'])?$intr['name']:''?></span></p>
            <div class="lawyers clearfix">
                <div class="l_img fl">
                    <img src="<?php echo 'http://admin.zcb2016.com/'.$intr['picture']?>" height="372" width="318" alt="">
                </div>
                <div class="r_text fl">
        ...
        <script type="text/javascript">
            $('.cear').load('<?php echo yii\helpers\Url::toRoute('/homepage/record')?>');
            $(function(){
              $('.record').click(function(){
                  $('.cear').load('<?php echo yii\helpers\Url::toRoute('/homepage/record')?>');
              });
                $('.evaluate').click(function(){
                    $('.cear').load('<?php echo yii\helpers\Url::toRoute('/homepage/evaluate')?>');
                });
                $('.level').click(function(){
                    $('.cear').load('<?php echo yii\helpers\Url::toRoute('/homepage/star')?>');
                })
            })
