...
<script type="text/javascript">
    function drawChart(data){
        ...
        var option = {
            colors: ['#7FA3C7', '#7FA3C7', '#7FA3C7', '#7FA3C7', '#7FA3C7'],  //线条的颜色
            ieBackgroundColor:'#7FA3C7',                    //选中时的背景颜色
            shadowSize:5,                                 //线条阴影
            ...
            grid: {
                color: '#7FA3C7',      // =>  表格外边框和标题以及所有刻度的颜色
...
<script type="text/javascript">
    ...
    var data = [
        { data : bj,lines : { show : true }, points : { show : false }},
    ];
    drawChart(data);
</script>
</body>
