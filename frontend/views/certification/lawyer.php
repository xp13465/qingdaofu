...
<div class="gren">
    <div class="gren_xi">
        <div class="personal_xi clearfix">
            <h4>律所基本信息</h4>
            <span></span>
            <p>(律所可发布清收、诉讼，可代理诉讼、清收)</p>
            <?php if(\common\models\Certification::findOne(['uid'=>Yii::$app->user->getId()])){?>
			<?php if(isset($certi->state)&&$certi->state == 2){ ?>
				<a href="<?php echo \yii\helpers\Url::toRoute(['/certification/perfect','type'=>2])?>">
        ...
        <ul>
            <li>
                <span class="xi_l">律所名称 :</span>
                <span class="grey"><?php echo $certi->name ?></span>
            </li>
            <li>
                <span class="xi_l">执业证号 :</span>
        ...
        <div class="yi3">
            <a href="<?php echo \yii\helpers\Url::toRoute(['/certification/add','type'=>2,'modify'=>3])?>">
