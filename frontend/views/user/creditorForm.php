...
<?php \yii\widgets\ActiveForm::begin(['id'=>'financing','method'=>'post','options'=>['enctype'=>"multipart/form-data"],])?>
    ...
    <div class="detail pl">
        <ul>
            ...
            <li>
                <label for="">借款本金 : <?php echo html::input('text','money',$model->money)?> 元<i></i></label>
            </li>
            <li>
            ...
            <li>
                ...
                <div style="display: inline-block;float: left;"><?php echo html::dropDownList('rate_cat',$model->rate_cat,CreditorProduct::$ratedatecategory,['onchange'=>'ratecatchange(this.value)'])?><i></i></div>
            </li>
            <li>
            ...
            <li class="mr">担保物 (抵押物) 所在地 <?php echo  html::dropDownList('city_id','310100',['310100'=>'上海市']);?> <label><?php echo  html::dropDownList('district_id',$model->district_id,array_merge([''=>'请选择'],\frontend\services\Func::getDistrictByCity('310100')));?> <i></i></label><label><?php echo html::input('text','seatmortgage',$model->seatmortgage)?><i></i></label></li>
            ...
            <li>　　　　 <label for="">(2)欠债人是否能正常联系: <?php echo html::radio('judicialstatusB',$model->judicialstatusB==1,['value'=>1])?>可联</label> <label for=""><?php echo html::radio('judicialstatusB',$model->judicialstatusB == 2,['value'=>2])?>失联</label><i></i>
            </li>
            <li>
            ...
            <li class="money">
                <b>
                    代理费用 :(1) 固定<?php echo html::input('text','agencycommissionf','',['class'=>"tian"])?>元                     <i class="wenhao"></i>
                                <span class="wenhao">
                ...
                　　
                <b>
                    　　　(2) 风险费率  <?php echo html::input('text','agencycommissions','',['class'=>"tian"])?>%
                    <i></i>
                                <span>
                                    固定指固定收费代理，是指律师服务费作为收取的固定费用，
                                    收取的费用与案件的处理结果无关。<em></em>
            ...
            <?php }
                      ...
                      <li>
                          <ul>
                              ...
                              <li>《接款合同》<input type="file" accept = 'image/*' name="CreditorProduct[imgcontract]"><span class="color">上传 +</span><em name="imgcontract"></em>　<?php if($files['imgcontract']){echo '<span class="suolve" status="1">详情 <i class="box"></i></span>';}else{echo '';}?></li>
        ...
        <script>
            ...
            $(function(){
                ...
                $('.suolve').hover(function(){
                     ...
                     $(this).children('i').css({'background':'url(/'+img[img_index]+') no-repeat center center','background-size':'145px 145px'});
                     $(this).children('i').stop().fadeToggle(500);
                });
            })
