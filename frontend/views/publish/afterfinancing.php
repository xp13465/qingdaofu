...
<div class="content_right">
    ...
    <script type="text/javascript">
        ...
        function SaveForm(){
            ...
            registerSave($("input[name='money']").val(),$("input[name='term']").val());
        ...
        function registerSave(money,term){
            $.msgbox({
                height:190,
                width:350,
                title:' ',
                ...
                '万元</p><p>融资期限：' +term+"<?php if($model->rate_cat == 1){echo '天';}else{echo '月';}?>"+
        ...
        function registerProtocol(money,term){
            $.msgbox({
                height:190,
                width:350,
