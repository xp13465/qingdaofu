    ...
    <div class="detail pl">
        ...
        <ul>
            <li>
                ...
                <?php
                if(is_numeric($model->guaranteemethod)){
                }else{ ?>
            <li class="guaran">
                <?php
            ...
            <li class="accountr">
                <span>应收账款</span><?php echo html::input('text','accountr',$model->accountr,['style'=>'width:323px'])?><i></i>
            </li>

            <li>
                <span>借款本金</span><?php echo html::input('text','money',$model->money,['placeholder'=>$AplaceHolder,'style'=>'width:170px;','class'=>'number'])?> 万元<i></i>
            </li>
            <li>
                <span>借款期限</span><?php echo html::input('text','term',$model->term,['placeholder'=>$bplaceHolder,'style'=>'width:230px;'])?>月<i></i>
            </li>
            <li>
            ...
            <li>
                <?php if(isset($model->category)&&$model->category == 2){?>
                    <?php echo '';?>
                <?php }else{?>
            ...
            <li>
                ...
                <input type="button" value="保存" onclick="SaveForm()" class="buttonev01">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $("#financing").validate({
                    ...
                    messages: {
                        ...
                        agencycommissionf: "请填写固定金额或者填写费率",
            ...
            function registerSave(money,commissionperiod){
                $.msgbox({
                    height:190,
                    width:360,
                    content:'<p>您保存的<?php if(isset($model->category)&&$model->category == 2){echo '清收';}else{echo'诉讼';}?>信息如下:</p><p><?php if(isset($model->category)&&$model->category == 2){echo '清收';}else{echo'诉讼';}?>金额：' +money+
            ...
            function registerProtocol(money,commissionperiod){
                $.msgbox({
                    height:210,
                    width:360,
                    content:'<p>您发布的<?php if(isset($model->category)&&$model->category == 2){echo '清收';}else{echo'诉讼';}?>信息如下:</p><p><?php if(isset($model->category)&&$model->category == 2){echo '清收';}else{echo'诉讼';}?>金额：' +money+
