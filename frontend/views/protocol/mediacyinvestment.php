<div class="wt_xieyi">
    ...
    <p>乙方通过网络服务平台为甲方提供居间服务，甲方应向乙方支付居间服务费。
        居间服务费的收取方式如下：</p>
    <p>1.甲方通过乙方网络服务平台的居间服务与借款人用户达成借款的初步意向并相互取得联系方式。双方初步确定借款合同的标的金额为人民币<b class="b1 fw"><?php echo isset($desc->money)?$desc->money:''?>万元</b>，借款期限为<b class="b1 fw"><?php if(isset($desc->rate_cat)){if($desc->rate_cat == 1)echo $desc->term;elseif($desc->rate_cat == 2)echo 30*$desc->term;}?></b>天，借款月利率为<b class="b1 fw"><?php if(isset($desc->rate_cat)){if($desc->rate_cat == 1)echo 30*$desc->rate;elseif($desc->rate_cat == 2)echo $desc->rate;}?></b>%。</p>
