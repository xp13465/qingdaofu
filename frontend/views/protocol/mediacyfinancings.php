...
<div class="write" style="max-width:100%;width:640px;margin:auto;">
    ...
    <p>1.甲方通过乙方网络服务平台的居间服务与出借人用户达成借款的初步意向并相互取得联系方式。双方初步确定借款合同的标的金额为人民币<b class="b1 fw"><?php echo isset($data['money'])?$data['money']:''?>万元</b>，借款期限为<b class="b1 fw"><?php if(isset($data['rate_cat'])){if($data['rate_cat'] == 1)echo $data['term'];elseif($data['rate_cat'] == 2)echo 30*$data['term'];}?></b>天，借款月利率为<b class="b1 fw"><?php if(isset($data['rate_cat'])){if($data['rate_cat'] == 1)echo 30*$data['rate'];elseif($data['rate_cat'] == 2)echo $data['rate'];}?></b>%。</p>
