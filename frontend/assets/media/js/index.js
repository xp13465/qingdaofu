...
$(function(){
  ...
  $(".alert").fadeTo(2000, 500).slideUp(500, function () {
	...
	$('.rec_r').click(function(){
		num3++;
		if(num3>2){ num3=2;}
		$('.rec_detail ul').stop().animate({'left':'-'+240*num3+'px'});
	})
	$('.rec_l').click(function(){
		num3--;
		if(num3<0){ num3=0;/*$('.rec_detail ul').css('left','0')*/}
		$('.rec_detail ul').stop().animate({'left':'-'+240*num3+'px'})
	})
	/*消息已读 未读切换*/
...
*/
    ...
    function lunbo() {
           ll++;
            ...
            $('.huoban2 ul').stop().animate({'left':'-'+ll*140+'px'})  
        }
	...
	timer1=setInterval(lunbo1,8000);
    ...
    $('.banners2 ol li').mouseover(function(event) {
    	...
    	$('.banners2 ul li').eq($(this).index()).stop().fadeIn(400).siblings().stop().fadeOut(400);
    });
