...
Dialog.prototype.create = function () {
   ...
   <table id="_DialogTable_' + this.ID + '" width="' + (this.Width + 26) + '" cellspacing="0" cellpadding="0" border="0" onselectstart="return false;" style="-moz-user-select: none; font-size:12px; line-height:1.4;">\
    <tr id="_Draghandle_' + this.ID + '" style="' + (this.Drag ? "cursor: move;" : "") + '">\
      ...
      <td height="33" style="border-radius:3px;background:#0da3f8;><div style="padding: 9px 5px 0 4px;color:#fff;"><span id="_Title_' + this.ID + '">' + this.Title + '</span></div>\
        ...
        return "";
          ...
          <tr id="_ButtonRow_' + this.ID + '" style="' + (this.ShowButtonRow ? "" : "display:none") + '">\
            <td height="36"><div id="_DialogButtons_' + this.ID + '" style="border-top: 1px solid #DADEE5; padding: 8px 20px; text-align: right; background-color:#f6f6f6;">\
               \
                <input type="button" class="buttonStyle" value="提交申请" style="color:#fff;background:#0da3f8;border:0px solid gray;border-radius:3px;" onclick="Dialog.getInstance(\'' + this.ID + '\').close();" id="_ButtonCancel_' + this.ID + '"/>\
              </div></td>\
          </tr>\
        </table></td>\
      <td width="13"></td>\
...
Dialog.alert = function (msg, func, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" width="300" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td style="text-align:center;float:left;padding-top:20px;padding-left:5px;">评估结果</td>\
		</tr>\
		<tr><td style="color:#dfbb27;font-size:30px;padding-top:20px;padding-left:5px;">500万</td>\</tr>\
		<tr><td></td>\
		<td></td>\
		<td style="color:#0da3f8;padding-top:-20px;">三林新村46号108室</td></tr>\
		<tr><td></td>\
		<td></td>\
		<td>地址：永泰路486弄</td></tr>\
		<tr><td></td>\
		<td></td>\
		<td>均价：46390元/平米</td></tr>\
		<tr><td></td>\
		<td></td>\
		<td>面积：100平米</td></tr>\
		<tr><td></td>\
...
Dialog.confirm = function (msg, funcOK, funcCal, w, h) {
    ...
    diag.InnerHtml = '<table height="100%" border="0" align="center" cellpadding="10" cellspacing="0">\
		<tr><td style="width:45px;float:left;padding-top:2px;">*小区</td>\
          <td><input type="text" id="username" style="width:100px;height:20px;"></td>\
			</tr>\
			<tr><td style="padding-top:5px;">*楼栋</td>\
			<td><input type="text" id="userpwd" style="width:100px;height:20px;"></td>\
			<td style="padding-top:10px;">号</td><td><input type="text" id="userpwd" style="width:100px;height:20px;"></td><td style="padding-top:5px;">室</td></tr>\
			<tr> <td style="padding-top:5px;">*面积</td> <td><input type="text" id="username" style="width:100px;height:20px;"></td><td style="padding-top:5px;">M2</td></tr>\
			<tr><td style="padding-top:5px;">*楼层</td> <td><input type="text" id="userpwd" style="width:100px;height:20px;"></td><td style="width:45px;float:left;padding-top:5px;">层/共</td> <td><input type="text" id="userpwd" style="width:100px;height:20px;"></td></tr>\
	</table>';
    diag.show();
    diag.okButton.parentNode.style.textAlign = "center";
    diag.okButton.focus();
