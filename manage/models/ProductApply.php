...
class ProductApply extends \yii\db\ActiveRecord
{
	...
	public function getUser(){
		return $this->hasOne(User::className(),['id'=>'create_by'])->alias('user')->select(['id','mobile','username','realname']);
	}
	
	 public function getCertification()
    {
        return $this->hasOne(Certification::className(),['uid' =>'create_by'])->alias("certifications");
    }
