...
class ProductMortgage extends \yii\db\ActiveRecord
{
	...
	public function getProvincename(){
		return $this->hasOne(Province::className(), ['provinceID'=>'relation_1'])->select('province,provinceID');
	}
	public function getCityname(){
		return $this->hasOne(City::className(), ['cityID'=>'relation_2'])->select('city,cityID');
	}
	public function getAreaname(){
		return $this->hasOne(Area::className(), ['areaID'=>'relation_3'])->select('area,areaID');
	}
	
	public function getBrand(){
		return $this->hasOne(Brand::className(), ['id'=>'relation_1'])->select('id,name');
	}
	
	public function getAudi(){
		return $this->hasOne(Audi::className(), ['id'=>'relation_2'])->select('id,name');
	}
