...
class Product extends \yii\db\ActiveRecord
{
	...
	*/
    ...
    {
        return $this->hasOne(User::className(), ['id' => 'create_by'])->alias('userMobile')->select(['id','mobile','username','realname']);
    }
	
	 public function getUserName()
    {
        return $this->hasOne(Certification::className(),['uid' =>'create_by'])->alias("certification");
    }
    ...
    {
        return $this->hasOne(Certification::className(),['uid' =>'create_by'])->alias("certification")->select(['certification.name','certification.email','certification.cardno','certification.state']);
    }
	...
	// public function getSolutionseal(){
		// return $this->hasOne(Solutionseal::className(),['productid'=>'productid'])->alias('solutionseal')->joinWith(['auditLog']);
	// }
	...
	*/
	...
	public function productView(){
		if(!$this->productid)return PARAMSCHECK;
