...
class ProductOrdersOperator extends \yii\db\ActiveRecord
{
    ...
    {
        return 'zcb_product_orders_operator';
    }
    ...
    {
        return $this->hasOne(User::className(), ['id' => 'operatorid']);
    }
	
	public function getOperatorCertification()
    {
        return $this->hasOne(Certification::className(), ['uid' => 'operatorid'])->alias('operatorCertification')->select(['operatorCertification.name','operatorCertification.uid']);
    }
	/**
     * @return \yii\db\ActiveQuery
     */
    ...
    {
        return $this->hasOne(User::className(), ['id' => 'operatorid'])->alias("userinfo")->joinWith("headimg")
