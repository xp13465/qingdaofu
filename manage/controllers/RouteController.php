...
use Yii;
use manage\models\Route;
use manage\components\MenuHelper;
use yii\caching\TagDependency;
use yii\web\Response;
use manage\components\RouteRule;
use manage\components\Configs;
 ...
 * @since 1.0
 */
class RouteController extends \manage\components\BackController
{
    const CACHE_TAG = 'manage.route';
