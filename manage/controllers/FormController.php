...
use manage\models\FormCategory;
use manage\models\search\FormSearch;
use manage\behaviors\StatusController;
...
class FormController extends BackController
{
    ...
    public $modelClass = 'manage\models\Form';
    public $modelSearchClass = 'manage\models\search\FormSearch';
