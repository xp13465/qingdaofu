...
/* @var $searchModel app\models\AttendanceGooutSearch */
...
if($type == '1' ){ 
	$this->title = '我的外出单';
	$this->blocks['content-header'] = Html::a('我的外出单', ['index'], ['class' => 'btn btn-default active']);
	...
	$this->blocks['content-header'].= "　".Html::a('添加外出单', ['create'], ['class' => 'btn btn-primary']);
 } 
...
?>
<div class="attendance-goout-index"> 
